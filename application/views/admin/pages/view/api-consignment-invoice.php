            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info " id="section-to-print">
                        ...
                        // $consignment_detl = fetch_details('consignments', ['order_id' =>  $order_detls[0]['order_id']]);
                        // $delivery_charge = '';

                        // if ($consignment_detl[0]['id'] < $consignments[0]['id']) {
                        //     $delivery_charge  = '0';
                        // } else {
                        //     $delivery_charge = $order_caharges_data[0]['delivery_charge'];
                        // }
                        ?>
                        <!-- info row -->
                                            ...
                                            <?php if ($order_detls[0]['type'] != 'digital_product') { ?>
                                                <tr>
                                                    <th>Delivery Charge (
                                                        <?= $settings['currency'] ?>)</th>
                                                    <td>+
                                                        <?php $cal_final_total += $consignments['0']['delivery_charge'];
                                                        echo number_format($consignments['0']['delivery_charge'], 2); ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            <tr class="d-none">
