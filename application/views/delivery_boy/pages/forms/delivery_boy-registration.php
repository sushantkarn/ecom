            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <!-- <form class="form-horizontal form-submit-event" action="<?//= base_url('delivery_boy/login/create_delivery_boy'); ?>" method="POST" id="add_dboy_form"> -->
                        <form class="form-horizontal form-submit-event" method="POST" id="add_dboy_form">
