                            ...
                            <div class="card-header bg-white p-2">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="flex-col my-auto d-flex gap-2">
                                        ...
                                        ?>
                                        <button class="btn btn-info btn-sm reorder-btn" data-variants="<?= $variants ?>" data-quantity="<?= $qty ?>"><?= !empty($this->lang->line('reorder')) ? $this->lang->line('reorder') : 'Reorder' ?></button>
                            ...
                            <div class="card-footer bg-white px-sm-3 pt-sm-4 px-0">
                                <div class="row text-center ">
                                    ...
                                    <?php if ($row['payment_method'] == 'Bank Transfer') { ?>
                                        <div class="col my-auto ">
                                            <h5>
                                                <a class="block buttons btn-sm btn btn-outline-primary mt-3 m-0" href="<?= base_url('my-account/order-details/' . $row['id']) ?>"> <?= !empty($this->lang->line('send_bank_payment_receipt')) ? $this->lang->line('send_bank_payment_receipt') : 'Send Bank Payment Receipt' ?></i>
